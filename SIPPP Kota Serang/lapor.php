...
<head>
    ...
    <title>Lapor | Pemerintah Kota Serang</title>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" placeholder="contoh@domain.com" value="<?= @$_GET['email'] ?>" required>
                                </div>
                                <p class="error"><?= @$_GET['emailError'] ?></p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="telpon" class="col-sm-3 control-label">Telepon</label>
                            <div class="col-sm-9">
                                <div class="input-group">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="tujuan">
                                        <option value="1">Dinas Kependudukan dan Pencatatan Sipil</option>
                                        <option value="2">Dinas Komunikasi, Informatika, Persandian dan Statistik</option>
                                        <option value="3">Badan Perencanaan Pembangunan, Penelitian dan Pengembangan Daerah</option>
