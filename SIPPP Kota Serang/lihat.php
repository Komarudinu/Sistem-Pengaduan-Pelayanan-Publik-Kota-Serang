...
<head>
    ...
    <title>Lacak Pengaduan | Pemerintah Kota Serang</title>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="lihat">LACAK PENGADUAN</a></li>
                    ...
                    <form class="form-horizontal" role="form" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-4">
                                <input id="submit" name="submit" type="submit" value="Lacak Pengaduan" class="btn btn-primary-custom form-shadow">
                            </div>
                        </div>
                    </form>
                </div>
